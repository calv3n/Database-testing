...
//        final Map resstring = await getUsers();
          ...
          if (v["emailid"] == grpd.groupmembers[i].EmailId) {
            ...
            if (v["groupsIamin"] == null) {
             ...
             await httpClient.put(
                  url: 'https://flutterfirebasefyp.firebaseio.com/users/${k}/groupsIamin.json?',
              ...
              var response1 = await httpClient.put( url:
                  'https://flutterfirebasefyp.firebaseio.com/users/${k}/groupsIamin.json?',
                  body: groupsIaminjson);
            }
          }
        });
      ...
      var url = "https://flutterfirebasefyp.firebaseio.com/groups.json";
